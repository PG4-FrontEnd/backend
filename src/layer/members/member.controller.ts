...
import {
  InviteMemberDto,
  RemoveMemberDto,
  UpdateMemberAuthorizationDto,
} from "./dto_m/member.dto";
import {
  ApiTags,
  ApiOperation,
  ApiParam,
...
export class MemberController {
  ...
  @ApiOperation({
    summary: "팀원 초대",
    description: "이메일로 새로운 팀원을 초대합니다.",
  })
  ...
  @ApiOperation({
    summary: "팀원 목록 조회",
    description: "프로젝트의 모든 팀원 정보를 조회합니다.",
  })
  @ApiParam({ name: "projectId", description: "프로젝트 ID" })
  @ApiResponse({
    status: 200,
